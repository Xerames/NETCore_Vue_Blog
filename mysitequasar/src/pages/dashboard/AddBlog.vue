        ...
        <q-card>
              ...
              <q-list>
                ...
                <q-item>
                  <q-item-section>
                    ...
                    <small v-if="$v.image.$invalid" class="text-red"
                ...
                <q-item>
                  <q-item-section>
                    <q-editor
                      ...
                      :rules="[
                        val =>
                          this.$v.blog.content.required || 'Content is required'
                      ]"
                      min-height="15rem"
                    />
                ...
                <q-item>
                  <q-item-section>
                    <q-select
                      ...
                      :rules="[
                        val =>
                          this.$v.blog.categoryId.required ||
                ...
                <div v-for="tag in tags" :key="tag.id">
                  <label class="b-contain">
                    ...
                    <input
                      ...
                      :rules="[
                        val =>
                          this.$v.blog.selectedtags.required ||
                          'Please select tag'
                      ]"
                    />
          ...
          <q-card-actions align="center" class="text-teal">
            <q-btn
              label="Add Blog"
              @click="AddBlog"
              :disabled="$v.blog.$invalid || $v.image.$invalid"
              color="primary"
            />
          </q-card-actions>
        </q-card>
